...
This module allows to assign a seller to several sell channels.
...
1. Assign a seller to different sales channels and the seller won't be deleted from the previous assigned sales channel.
